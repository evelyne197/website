	...
	<body>
		<header>
			<div class="header__content">
				...
				<div class="stage">
					<picture>
						<source media="(max-width: 767px)" srcset="content/assets/small/4.jpg">
						<source media="(min-width: 768px)" srcset="content/assets/4.jpg">
						<img src="content/assets/4.jpg" alt="">
					</picture>
				</div>
			</div>
		</header>
		<main>
			<?php include('./content/html/datenschutz.html'); ?>
		</main>
